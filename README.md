...
Customers can choose a basic coffee type, and then add various toppings or flavor shots. The system must allow for any combination of additions.

### Key Requirements
- **Core Component**: A basic coffee (Espresso, Black Coffee) with a base cost.
- **Dynamic Enhancements**: Additions like Milk, Sugar, Caramel Syrup, and Whipped Cream must be applied on top of the basic coffee.
